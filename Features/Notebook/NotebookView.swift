...
private struct MacEditorToolPalette: View {
    ...
    private let primaryTools: [MacDrawingTool] = [.pen, .pencil, .highlighter, .eraser, .lasso]
    ...
    private func selectShape(_ shape: MacDrawingTool) {
...
private struct FloatingWritingToolbar: View {
    ...
    private let tools: [MacDrawingTool] = [.pen, .pencil, .highlighter, .eraser, .lasso]
...
private extension MacDrawingTool {
    ...
    var keyboardShortcut: KeyEquivalent {
        ...
        case .lasso: return "v"
        case .rectangle, .circle, .line, .arrow: return "d"
        }
    }
}
