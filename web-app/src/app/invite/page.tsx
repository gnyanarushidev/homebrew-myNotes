...
export default async function InvitePage() {
  ...
  if (access.status === "admin") redirect("/reset-password");
  return <AuthFrame eyebrow="YOUR INVITATION" title="Open your setup email." description="Use the link in your MyNotes invitation to verify your account and choose a password.">
    <p>If you already activated your administrator account, you can sign in below. If your link has expired, request a new password-reset email.</p>
